...
private:
    ...
    constexpr static const int mg_pawn_table[64] = {
            0, 0, 0, 0, 0, 0, 0, 0,
    ...
    constexpr static const int eg_pawn_table[64] = {
            0, 0, 0, 0, 0, 0, 0, 0,
    ...
    constexpr static const int mg_knight_table[64] = {
    ...
    constexpr static const int eg_knight_table[64] = {
    ...
    constexpr static const int mg_bishop_table[64] = {
    ...
    constexpr static const int eg_bishop_table[64] = {
    ...
    constexpr static const int mg_rook_table[64] = {
    ...
    constexpr static const int eg_rook_table[64] = {
    ...
    constexpr static const int mg_queen_table[64] = {
    ...
    constexpr static const int eg_queen_table[64] = {
    ...
    constexpr static const int mg_king_table[64] = {
    ...
    constexpr static const int eg_king_table[64] = {
    ...
    constexpr static const int mg_value[6] = {102, 357, 385, 497, 1045, 20};
    constexpr static const int eg_value[6] = {114, 301, 317, 532, 956, 20};
